...
/* HERO */
.hero { position:relative; min-height:560px; display:flex; align-items:center; overflow:hidden; background-image:url('/images/pba-hero.png'); background-size:cover; background-position:center; }
