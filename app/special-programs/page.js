...
.hero h1 { font-family:var(--font-heading),'Playfair Display',serif; font-size:46px; font-weight:400; line-height:1.1; letter-spacing:-1.5px; margin-bottom:16px; color:#2C2A26; position:relative; }
...
.prog-card h3 { font-family:var(--font-heading),'Playfair Display',serif; font-size:22px; font-weight:400; margin-bottom:10px; }
.prog-card .desc { font-size:14px; color:#8A857A; line-height:1.7; flex:1; }
.prog-card .btn-p { display:inline-block; text-decoration:none; background:#6C1A55; color:#fff; padding:14px 28px; border-radius:100px; font-size:14px; font-weight:700; font-family:var(--font-lato),'Lato',sans-serif; text-align:center; margin-top:20px; transition:all 0.25s; }
...
.apply-section h2 { font-family:var(--font-heading),'Playfair Display',serif; font-size:32px; font-weight:400; margin-bottom:16px; }
.apply-section p { font-size:15px; color:#8A857A; line-height:1.7; margin-bottom:28px; }
.apply-section .btn-p { display:inline-block; text-decoration:none; background:#6C1A55; color:#fff; padding:16px 36px; border-radius:100px; font-size:15px; font-weight:700; font-family:var(--font-lato),'Lato',sans-serif; transition:all 0.25s; }
.apply-section .btn-p:hover { background:#8B3572; }

/* FAQ */
.faq-section { padding:80px 48px; max-width:800px; margin:0 auto; }
.faq-section h2 { font-family:var(--font-heading),'Playfair Display',serif; font-size:32px; font-weight:400; text-align:center; margin-bottom:40px; }
...
.btn-w { display:inline-block; text-decoration:none; background:#fff; color:#6C1A55; padding:16px 36px; border-radius:100px; font-size:15px; font-weight:700; border:none; cursor:pointer; font-family:var(--font-lato),'Lato',sans-serif; transition:all 0.25s; }
.btn-w:hover { background:rgba(255,255,255,0.85); }
.btn-gd { display:inline-block; text-decoration:none; background:transparent; color:#fff; padding:16px 36px; border-radius:100px; font-size:15px; font-weight:700; border:1px solid rgba(255,255,255,0.25); cursor:pointer; font-family:var(--font-lato),'Lato',sans-serif; transition:all 0.25s; }
