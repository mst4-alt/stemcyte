...
.hero .bg { position:absolute; inset:0; background:url('/images/our%20story/hero_ourstory.jpg') center/cover; filter:saturate(0.7); }
...
/* MISSION */
.mission-quote { font-family:'Playfair Display',serif; font-size:26px; font-weight:400; line-height:1.35; color:#2C2A26; max-width:820px; margin:0 auto; text-align:center; letter-spacing:-0.3px; }
.mission-quote em { color:#E8A0D0; font-style:italic; }
...
/* GLOBAL IMPACT MAP */
.gb-section { background:linear-gradient(170deg,#3D0F31 0%,#2A0A22 100%); padding:80px 0; overflow:hidden; position:relative; }
.gb-inner { max-width:1200px; margin:0 auto; padding:0 48px; }
.gb-header { text-align:center; margin-bottom:48px; }
.gb-header .lbl { font-size:11px; font-weight:700; letter-spacing:1.5px; text-transform:uppercase; color:#C06AA5; margin-bottom:10px; }
.gb-header h2 { font-family:'Playfair Display',serif; font-size:36px; font-weight:400; letter-spacing:-0.5px; line-height:1.15; color:#fff; }
.gb-map-wrap { position:relative; width:100%; max-width:960px; margin:0 auto; }
.gb-map-wrap svg { width:100%; height:auto; display:block; }
.gb-dot-core { fill:#E8A0D0; }
.arc-line { stroke-dasharray:600; stroke-dashoffset:600; animation:draw-arc 3s cubic-bezier(0.4,0,0.2,1) forwards; }
.arc-line:nth-child(1){animation-delay:0.2s}
.arc-line:nth-child(2){animation-delay:0.4s}
.arc-line:nth-child(3){animation-delay:0.6s}
.arc-line:nth-child(4){animation-delay:0.8s}
.arc-line:nth-child(5){animation-delay:1.0s}
.arc-line:nth-child(6){animation-delay:1.2s}
.arc-line:nth-child(7){animation-delay:1.4s}
.arc-line:nth-child(8){animation-delay:1.6s}
.arc-line:nth-child(9){animation-delay:1.8s}
.arc-line:nth-child(10){animation-delay:2.0s}
.arc-line:nth-child(11){animation-delay:2.2s}
.arc-line:nth-child(12){animation-delay:2.4s}
@keyframes draw-arc { to { stroke-dashoffset:0; } }
.gb-stats { display:flex; gap:12px; justify-content:center; margin-top:48px; flex-wrap:wrap; }
.gb-stat { background:rgba(255,255,255,0.06); border:1px solid rgba(255,255,255,0.08); border-radius:12px; padding:20px 28px; text-align:center; min-width:140px; backdrop-filter:blur(8px); }
.gb-stat .num { font-family:'Source Serif 4',serif; font-size:32px; color:#E8A0D0; font-weight:400; line-height:1; }
.gb-stat .desc { font-size:11px; color:rgba(255,255,255,0.35); margin-top:4px; font-weight:600; text-transform:uppercase; letter-spacing:0.5px; }
.gb-callouts { display:flex; gap:6px; justify-content:center; flex-wrap:wrap; margin-top:24px; }
.gb-callout { font-size:11px; color:rgba(255,255,255,0.35); background:rgba(255,255,255,0.04); border:1px solid rgba(255,255,255,0.08); padding:5px 12px; border-radius:100px; white-space:nowrap; }
...
.btn-w { background:#fff; color:#6C1A55; padding:16px 36px; border-radius:100px; font-size:15px; font-weight:700; text-decoration:none; display:inline-block; }
.btn-gd { color:#fff; padding:16px 36px; border-radius:100px; font-size:15px; font-weight:700; border:1px solid rgba(255,255,255,0.25); text-decoration:none; display:inline-block; }
...
@media(max-width:900px) {
  ...
  .gb-inner { padding:0 24px; }
  .gb-header h2 { font-size:28px; }
  .gb-stats { gap:8px; }
  .gb-stat { padding:16px 20px; min-width:100px; }
  .gb-stat .num { font-size:26px; }
}
`;
...
<section class="gb-section">
  <div class="gb-inner">
    <div class="gb-header">
      <div class="lbl">Global reach</div>
      <h2>Where StemCyte units have saved lives</h2>
    </div>
    <div class="gb-map-wrap">
      <svg viewBox="30.767 241.591 784.077 458.627" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <radialGradient id="glow"><stop offset="0%" stop-color="#E8A0D0" stop-opacity="0.5"/><stop offset="100%" stop-color="#C06AA5" stop-opacity="0"/></radialGradient>
          <radialGradient id="glow-hq"><stop offset="0%" stop-color="#E8A0D0" stop-opacity="0.6"/><stop offset="50%" stop-color="#C06AA5" stop-opacity="0.15"/><stop offset="100%" stop-color="#C06AA5" stop-opacity="0"/></radialGradient>
        </defs>
        <g fill="rgba(192,106,165,0.18)" stroke="rgba(192,106,165,0.08)" stroke-width="0.3">
...
<path d="M468.52,578.226l7.755,8.757l5.946,1.513l3.984-6.248l-0.312-8.281l-6.465-3.337l-2.431,1.098l-3.62,5.524l-5.014-0.053L468.52,578.226L468.52,578.226z"/>
        ...
        <g fill="none">
          <path class="arc-line" stroke="rgba(232,160,208,0.12)" stroke-width="0.7" d="M130,410 Q180,340 225,385"/>
          <path class="arc-line" stroke="rgba(232,160,208,0.1)" stroke-width="0.6" d="M130,410 Q300,280 465,345"/>
          <path class="arc-line" stroke="rgba(232,160,208,0.1)" stroke-width="0.6" d="M130,410 Q400,280 620,430"/>
          <path class="arc-line" stroke="rgba(232,160,208,0.1)" stroke-width="0.6" d="M130,410 Q500,500 750,560"/>
          <path class="arc-line" stroke="rgba(232,160,208,0.1)" stroke-width="0.6" d="M130,410 Q200,480 310,535"/>
        </g>
        <g fill="none">
          <path class="arc-line" stroke="rgba(232,160,208,0.1)" stroke-width="0.6" d="M710,415 Q720,380 730,385"/>
          <path class="arc-line" stroke="rgba(232,160,208,0.1)" stroke-width="0.6" d="M710,415 Q718,395 718,388"/>
          <path class="arc-line" stroke="rgba(232,160,208,0.1)" stroke-width="0.6" d="M710,415 Q690,430 680,462"/>
          <path class="arc-line" stroke="rgba(232,160,208,0.1)" stroke-width="0.6" d="M710,415 Q660,410 620,430"/>
          <path class="arc-line" stroke="rgba(232,160,208,0.1)" stroke-width="0.6" d="M710,415 Q740,490 755,560"/>
          <path class="arc-line" stroke="rgba(232,160,208,0.08)" stroke-width="0.6" d="M710,415 Q590,350 465,345"/>
          <path class="arc-line" stroke="rgba(232,160,208,0.08)" stroke-width="0.6" d="M710,415 Q640,400 565,418"/>
        </g>
        <circle fill="#E8A0D0" r="1.5"><animateMotion dur="7s" repeatCount="indefinite" begin="1s" path="M130,410 Q300,280 465,345"/><animate attributeName="opacity" values="0;0.4;0.4;0" dur="7s" repeatCount="indefinite" begin="1s"/></circle>
        <circle fill="#E8A0D0" r="1.5"><animateMotion dur="8s" repeatCount="indefinite" begin="3s" path="M130,410 Q400,280 620,430"/><animate attributeName="opacity" values="0;0.35;0.35;0" dur="8s" repeatCount="indefinite" begin="3s"/></circle>
        <circle fill="#E8A0D0" r="1.5"><animateMotion dur="6s" repeatCount="indefinite" begin="5s" path="M710,415 Q660,410 620,430"/><animate attributeName="opacity" values="0;0.35;0.35;0" dur="6s" repeatCount="indefinite" begin="5s"/></circle>
        <circle fill="#E8A0D0" r="1.5"><animateMotion dur="7s" repeatCount="indefinite" begin="2s" path="M710,415 Q740,490 755,560"/><animate attributeName="opacity" values="0;0.3;0.3;0" dur="7s" repeatCount="indefinite" begin="2s"/></circle>
        <circle fill="#E8A0D0" r="1.5"><animateMotion dur="6.5s" repeatCount="indefinite" begin="4s" path="M710,415 Q590,350 465,345"/><animate attributeName="opacity" values="0;0.3;0.3;0" dur="6.5s" repeatCount="indefinite" begin="4s"/></circle>
        <circle cx="130" cy="410" r="8" fill="url(#glow-hq)"><animate attributeName="r" values="8;16;8" dur="5s" repeatCount="indefinite"/><animate attributeName="opacity" values="0.35;0.1;0.35" dur="5s" repeatCount="indefinite"/></circle>
        <circle class="gb-dot-core" cx="130" cy="410" r="3.5"/>
        <text x="130" y="398" text-anchor="middle" font-family="Lato" font-size="7" fill="#E8A0D0" font-weight="700" letter-spacing="1.5" opacity="0.5">STEMCYTE</text>
        <circle cx="710" cy="415" r="8" fill="url(#glow-hq)"><animate attributeName="r" values="8;16;8" dur="5s" begin="0.5s" repeatCount="indefinite"/><animate attributeName="opacity" values="0.35;0.1;0.35" dur="5s" begin="0.5s" repeatCount="indefinite"/></circle>
        <circle class="gb-dot-core" cx="710" cy="415" r="3.5"/>
        <text x="710" y="403" text-anchor="middle" font-family="Lato" font-size="7" fill="#E8A0D0" font-weight="700" letter-spacing="1.5" opacity="0.5">STEMCYTE</text>
        <circle class="gb-dot-core" cx="118" cy="403" r="2"/>
        <circle class="gb-dot-core" cx="165" cy="425" r="2"/>
        <circle class="gb-dot-core" cx="208" cy="400" r="2"/>
        <circle class="gb-dot-core" cx="124" cy="414" r="1.5"/>
        <circle class="gb-dot-core" cx="136" cy="414" r="1.5"/>
        <circle class="gb-dot-core" cx="137" cy="355" r="2"/>
        <circle cx="225" cy="385" r="5" fill="url(#glow)"><animate attributeName="r" values="5;10;5" dur="6s" begin="1s" repeatCount="indefinite"/><animate attributeName="opacity" values="0.2;0.06;0.2" dur="6s" begin="1s" repeatCount="indefinite"/></circle>
        <circle class="gb-dot-core" cx="225" cy="385" r="2.5"/>
        <circle cx="465" cy="345" r="5" fill="url(#glow)"><animate attributeName="r" values="5;10;5" dur="6s" begin="2s" repeatCount="indefinite"/><animate attributeName="opacity" values="0.2;0.06;0.2" dur="6s" begin="2s" repeatCount="indefinite"/></circle>
        <circle class="gb-dot-core" cx="465" cy="345" r="2.5"/>
        <circle class="gb-dot-core" cx="456" cy="338" r="1.5"/>
        <circle cx="620" cy="430" r="5" fill="url(#glow)"><animate attributeName="r" values="5;10;5" dur="6s" begin="3s" repeatCount="indefinite"/><animate attributeName="opacity" values="0.2;0.06;0.2" dur="6s" begin="3s" repeatCount="indefinite"/></circle>
        <circle class="gb-dot-core" cx="620" cy="430" r="2.5"/>
        <circle class="gb-dot-core" cx="680" cy="462" r="2"/>
        <circle class="gb-dot-core" cx="730" cy="385" r="2"/>
        <circle class="gb-dot-core" cx="718" cy="388" r="1.5"/>
        <circle class="gb-dot-core" cx="565" cy="418" r="1.5"/>
        <circle class="gb-dot-core" cx="755" cy="560" r="2"/>
        <circle class="gb-dot-core" cx="310" cy="535" r="1.5"/>
      </svg>
    </div>
    <div class="gb-stats">
