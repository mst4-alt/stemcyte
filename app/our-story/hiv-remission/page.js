        ...
        <div className={s.inner}>
          ...
          <div className={s.portraitSection}>
            ...
            <div ref={(el) => { animRef(el); }} className={s.animD1}>
              ...
              <p className={s.bodyP}><Link href="/our-story/lawrence-petz" style={{ color: 'inherit', textDecoration: 'underline', textDecorationColor: '#C06AA5', textUnderlineOffset: '3px' }}>Dr. Lawrence Petz</Link> was one of the most distinguished transfusion medicine physicians of his generation. Before joining StemCyte as Chief Medical Officer, he spent decades shaping the field from two of the country&rsquo;s leading institutions.</p>
